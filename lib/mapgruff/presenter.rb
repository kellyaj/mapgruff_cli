module Mapgruff
  class Presenter
    ...
    def initialize(output, incidents)
      @output = output
      @incidents = incidents
    ...
    def present
      @output.puts(create_top_box_row)
      @output.puts(create_header_row)
      @output.puts(create_separator_row)
      @incidents.each do |incident|
        @output.puts(create_data_row(incident))
      end
      @output.puts(create_bottom_row)
    end
